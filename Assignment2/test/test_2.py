api_key="35bdef93-53b8-4e5f-8347-82bb0b83ecba"
...
log_file_path = "./output/fewshot_prompt_correctdemo_norelat_qes.jsonl"
data_list = load_json_objects(filename)
prompt_path = "./prompt/fewshot_prompt_correctdemo_norelat_qes.json"
